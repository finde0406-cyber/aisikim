...
const FAQ = [
  ...
  {
    q: '결제하면 자료는 언제 오나요?',
    a: '카드 결제가 완료되는 즉시 입력하신 이메일로 PDF가 자동 발송돼요. 메일이 보이지 않으면 스팸함도 확인해주세요.',
  },
  {
    q: '환불은 어떻게 되나요?',
    a: '본 상품은 디지털 자료 상품이에요. 자료가 전달된 이후에는 상품 특성상 환불이 제한될 수 있어요. 상세 환불 기준은 이용약관에서 확인할 수 있어요.',
  },
]
  ...
  return (
    <main className="flex flex-col px-4 py-10 pb-20">
      <div className="max-w-sm mx-auto w-full">
        ...
        >
          <p className="text-xs text-gray-500">무료 가이드: ChatGPT로 블로그 글 쓰면 다 비슷해지는 이유</p>
        ...
        <div className="mt-8 border-t border-gray-100 pt-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="border-2 border-indigo-500 rounded-xl p-4 bg-white">
              ...
              <p className="text-xs text-gray-500">블로그·콘텐츠 작성에 집중한 흐름</p>
            </div>
