...
export default function HeroSection() {
  return (
    <section>
      <div className="px-4 pt-10 pb-8 mx-auto max-w-sm sm:max-w-2xl">
        <div className="sm:grid sm:grid-cols-2 sm:gap-10 sm:items-center">

          {/* 좌측 (desktop) / 상단 (mobile): 카피 + CTA */}
          <div className="text-center sm:text-left mb-6 sm:mb-0">
            <h1 className="text-[1.875rem] font-extrabold text-gray-900 leading-[1.2] tracking-tight mb-4">
              AI에게 뭘 시켜야 할지<br />
              모르겠다면,<br />
              <span className="text-indigo-600">직접 쓰지 말고<br className="sm:hidden" /> 선택하세요.</span>
            </h1>
